...
<html lang="en">
  ...
  <body>
         ...
         <div class="content-wrapper">
            ...
            <div class="card">
              <div class="card-body">
                <div class="row">
                  <div class="col-12"> 
                    <form id="search_ot" method="POST" action="<?php echo base_url();?>Mainapp/set_checklist_daily">     
                       <!--  ประเภท -->
                          <div class="row">
                               <div class="col-2 col-sm-2 col-md-2 col-lg-2 col-xl-2">
                                  <div class="form-group">
                                    <label>เลือกหัวข้อเช็ครถประจำวัน</label>
                                    ...
                                    <select class="js-example-basic-single" id="ft_veh_title_seq" name="ft_veh_title_seq" style="width: 100%;">
                                      <option value="">เลือก</option>
                                            <?php
                                                if($data_checklist_daily != ""){
                                                  foreach ($data_checklist_daily as $key => $value){
                    ...
                    <div class="row">
                      <div class="col-8 col-sm-8 col-md-8 col-lg-8 col-xl-8">
                          <div class="form-group" align="right" >
                            <button type="button"  onclick="modal_type(' เพิ่มเช็คลิสต์ตรวจเช็ครถประจำวัน ','#4e73df','A','')" id="" class='btn btn-primary btn-sm fs-14'><i class="fa fa-plus"></i> เพิ่ม</button>
                          </div>
                      </div>
                    </div>                        
                </div>
                ...
                <div class="col-8 col-sm-8 col-md-8 col-lg-8 col-xl-8">
                    <div class="table-responsive">
                      <table id="datatable-ot" class="table table-striped" style="width: 100%">
                        ...
                        <tr>
                          <th>หัวข้อเช็ครถประจำวัน</th>
                          <th>หัวข้อย่อยเช็ครถประจำวัน</th>
                                ...
                                foreach ($data_all as $key => $value) {
                                  echo "<tr>";
                                    ...
                                    echo "<td class='txt-center'>".
                                              "<button type='button' onclick=\"modal_type(' แก้ไขเช็คลิสต์ตรวจเช็ครถประจำวัน ','#FFC000','E','".$value->VEH_TITLE_SEQ."')\" class='btn btn-warning btn-sm' ><i class='fa fa-pencil-square-o m-tb-2 m-l-4 m-r-1'></i></button>".
                                            "</td>";
                                    echo "<td class='txt-center'>".
                                              "<button type='button' onclick=\"modal_type(' ลบเช็คลิสต์ตรวจเช็ครถประจำวัน ','#e74a3b','D','".$value->VEH_TITLE_SEQ."')\" class='btn btn-danger btn-sm' ><i class='fa fa-trash-o m-tb-2 m-lr-4'></i></button>".
                                            "</td>";
                                  echo "</tr>";
                                } 
                              }
                      ...
                      <div class="form-group">
                          <div class="table-responsive">
                            <table id="table-subroom" class="table table-striped">
                              <thead class="table-dark">
                                 <tr>
                                    <th width="35%">ลำดับรายการเช็คลิสต์</th>
                                    <th >รายการเช็คลิสต์</th>
                                    <th width="30%">ลบ</th>
                                 </tr>
                              </thead>
                              <tbody>
    ...
    <script type="text/javascript"  src="<?php echo base_url(); ?>assets/dist/js/script_set_checklist_daily.js?v=<?php echo rand(0,999999); ?>" ></script>
  </body>
</html>