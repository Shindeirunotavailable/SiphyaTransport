                        ...
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                <div class="form-group">
                                      ...
                                      <!-- <button type="button" onclick="tableToExcel('datatable-ot','')" class="btn btn-success" id="exporttable"><i class="fa fa-download"></i> excel</button>  -->
                                  </div>
                              </div>
                        </div>
                  </form>               
              ...
              <div class="modal-body">
                ...
                <h4 class="card-title">รายงานพนักงานขับรถต้นทาง</h4>  
                  <div class="row">
                    ...
                    <div class="col-12 col-sm-6 col-md-3 col-lg-3 col-xl-3">
                        <div class="form-group">
                          <label>น้ำหนักของที่บรรทุก (KG.) / จำนวนผู้โดยสาร</label>
