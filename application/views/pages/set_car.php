...
<html lang="en">
  ...
  <body>
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-12">
                       ...
                       <form id="search_ot" method="POST" action="<?php echo base_url();?>Mainapp/set_car">     
                          <div class="row">
                                        ...
                                        <?php
                                            if($data_type != ""){
                                              foreach ($data_type as $key => $value){
                                                echo "<option value='".$value->VEH_BRAND_CODE."'>".$value->VEH_BRAND_CODE." : ".$value->VEH_BRAND_NAME."</option>";     
                                              }
                                            } 
                                        ?>
                                    </select>
                    ...
                    <div class="row">
                      <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-6">
                          <div class="form-group" align="right" >
                            <button type="button"  onclick="modal_type(' ยี่ห้อรถ','#4e73df','A','')" id="" class='btn btn-primary btn-sm fs-14'><i class="fa fa-plus"></i> เพิ่ม</button>
                          </div>
                      </div>
                    </div>
                      <div class="row">
                                ...
                                <?php
                                    if($data_all != ""){
                                      foreach ($data_all as $key => $value) {
                                        echo "<tr>";
                                          echo "<td>".$value->VEH_BRAND_CODE."</td>"; 
                                          echo "<td>".$value->VEH_BRAND_NAME."</td>"; 
                                          echo "<td class='txt-center'>".
                                                    "<button type='button' onclick=\"modal_type(' แก้ไขยี่ห้อรถ','#de732f','E','".$value->VEH_BRAND_CODE."')\" class='btn btn-warning btn-sm' ><i class='fa fa-pencil-square-o m-tb-2 m-l-4 m-r-1'></i></button>".
                                                  "</td>";
                                          echo "<td class='txt-center'>".
                                                    "<button type='button' onclick=\"modal_type(' ลบยี่ห้อรถ','#e74a3b','D','".$value->VEH_BRAND_CODE."')\" class='btn btn-danger btn-sm' ><i class='fa fa-trash-o m-tb-2 m-lr-4'></i></button>".
                                                  "</td>";
                                        echo "</tr>";
                                      } 
                                    }
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                      <input  type="hidden" id="hd_flg" value="">
                        <div class="form-group">
                        <label>รหัสยี่ห้อรถ<font color="red"><i class="fa fa-asterisk" style="color: red;font-size: 10px"></i></font></label>
                        <input type="text" class="form-control fs-14" id="md_veh_brand_code">
                      </div>
                      <div class="form-group">
                        <label>ยี่ห้อรถ<font color="red"><i class="fa fa-asterisk" style="color: red;font-size: 10px"></i></font></label>
                        <input type="text" class="form-control fs-14" id="md_veh_brand_name">
                      </div>
                  </div> 
    ...
    <script type="text/javascript"  src="<?php echo base_url(); ?>assets/dist/js/script_set_car.js?v=<?php echo rand(0,999999); ?>" ></script>
